    ...
    >
      <div className="space-y-3 border-b border-border-default/60 px-4 py-4 sm:px-5">
        <div className="relative">
          ...
          />
          <Input
            placeholder="Search league, country, or Overtime ID…"
            value={search}
      ...
      {isLoading ? (
        ...
        <>
          <div className="hidden border-b border-border-default/60 bg-bg-elevated/20 px-5 py-2.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-text-muted lg:grid lg:grid-cols-[4rem_1fr_7rem_6rem_5.5rem] lg:gap-4">
            <span>Order</span>
            <span>League</span>
          ...
          <ul className="divide-y divide-border-default/50">
            {leagues.map((league) => (
              ...
              >
                <div className="flex flex-col gap-4 px-4 py-4 sm:px-5 lg:grid lg:grid-cols-[4rem_1fr_7rem_6rem_5.5rem] lg:items-center lg:gap-4">
                  <div className="flex items-center gap-3 lg:block">
                    <span className="text-[10px] font-semibold uppercase tracking-wider text-text-muted lg:hidden">
                      Order
                    </span>
                    <span className="inline-flex h-9 min-w-[2.25rem] items-center justify-center rounded-lg border border-border-default/70 bg-bg-primary/40 font-mono text-sm font-semibold tabular-nums">
                      {league.sortOrder}
                    </span>
                  </div>
