...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    'bg-gradient-to-r from-accent-secondary to-indigo-500 text-white hover:opacity-90 font-semibold shadow-glow-accent',
  secondary: 'bg-bg-elevated border border-border-default hover:bg-bg-surface text-text-primary',
